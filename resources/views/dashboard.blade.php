...
<head>
    ...
    <title>CRM - Personel Paneli</title>
    ...
    <style>
        ...
        * {
        ...
        /* Task ve Ticket Listesi Stilleri */
        .task-list,
        .ticket-list {
            display: flex;
            flex-direction: column;
        ...
        <div class="main-content">
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <div class="stat-value">{{ $assignedTasks ?? 0 }}</div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-value">{{ $supportTickets ?? 0 }}</div>
            ...
            <div class="content-grid">
                            ...
                            @foreach($upcomingTasks as $task)
                                <div class="task-item">
                                    <div class="task-info">
                                        ...
                                        <p class="task-due">Son Tarih: {{ \Carbon\Carbon::parse($task->due_date)->format('d.m.Y') }}</p>
                                    </div>
                ...
                <div class="table-card">
                    <div class="table-header">
                        <h2 class="table-title">Son Destek Talepleri</h2>
                        <a href="/support" class="nav-item">
                            <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                            ...
                            @foreach($recentTickets as $ticket)
                                <div class="ticket-item">
                                    <div class="ticket-info">
                                        ...
                                        <p class="ticket-date">{{ \Carbon\Carbon::parse($ticket->created_at)->format('d.m.Y H:i') }}</p>
                                    </div>
                    ...
                    @else
                        <div class="empty-state">
                            <i class="fas fa-headset"></i>
                            <p>Açık destek talebi bulunmamaktadır.</p>
                        </div>
                    @endif
                </div>
            </div>
