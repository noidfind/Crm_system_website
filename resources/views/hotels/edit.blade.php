...
<body>
    <div class="container">
        ...
        <form action="/hotels/{{ $hotel->id }}" method="POST" id="hotelForm">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <input type="text" id="address" name="address" value="{{ $hotel->address }}" required>
                @error('address')
                    <div class="error">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="phone" name="phone" value="{{ $hotel->phone }}" required>
                @error('phone')
                    <div class="error">{{ $message }}</div>
                @enderror
            </div>
